...
module "lambda" {
  ...
  lambda_get_course_role_arn    = module.iam.get_course_role_arn
  lambda_create_course_role_arn = module.iam.create_course_role_arn
  lambda_update_course_role_arn = module.iam.update_course_role_arn
  lambda_delete_course_role_arn = module.iam.delete_course_role_arn
}
